...
const columns: ColumnDef<PipelineRow>[] = [
  { key: 'campaign_name', header: 'Campaign', minWidth: 160, sortable: true,
    render: (r) => <span className="font-medium" style={{ color: 'var(--color-text-primary)' }}>{r.campaign_name}</span> },
  { key: 'market', header: 'Market', width: 80 },
  { key: 'leads', header: 'Leads', align: 'right', width: 70, sortable: true,
    render: (r) => <span className="tabular-nums" style={{ fontFamily: 'var(--font-jetbrains-mono)' }}>{r.leads}</span> },
  { key: 'emails_sent', header: 'Sent', align: 'right', width: 70, sortable: true,
    render: (r) => <span className="tabular-nums" style={{ fontFamily: 'var(--font-jetbrains-mono)' }}>{r.emails_sent}</span> },
  { key: 'responses_positive', header: 'Responses', align: 'right', width: 90, sortable: true,
    render: (r) => <span className="tabular-nums" style={{ fontFamily: 'var(--font-jetbrains-mono)' }}>{r.responses_positive}</span> },
  { key: 'underwritten', header: 'UW', align: 'right', width: 60, sortable: true,
    render: (r) => <span className="tabular-nums" style={{ fontFamily: 'var(--font-jetbrains-mono)' }}>{r.underwritten}</span> },
  { key: 'scored_good', header: 'Good', align: 'right', width: 65, sortable: true,
    render: (r) => <span className="tabular-nums" style={{ fontFamily: 'var(--font-jetbrains-mono)' }}>{r.scored_good}</span> },
  { key: 'loi_count', header: 'LOI', align: 'right', width: 60, sortable: true,
    render: (r) => <span className="tabular-nums" style={{ fontFamily: 'var(--font-jetbrains-mono)' }}>{r.loi_count}</span> },
  { key: 'closed_count', header: 'Closed', align: 'right', width: 70, sortable: true,
    render: (r) => <span className="tabular-nums" style={{ fontFamily: 'var(--font-jetbrains-mono)' }}>{r.closed_count}</span> },
];
