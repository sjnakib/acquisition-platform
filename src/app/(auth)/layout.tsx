...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div 
      ...
      className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden transition-all duration-300 select-none w-full" 
