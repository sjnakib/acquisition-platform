        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full h-9 rounded-md border border-slate-300 px-3 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full h-9 rounded-md border border-slate-300 px-3 pr-10 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
              <button
                type="button"
